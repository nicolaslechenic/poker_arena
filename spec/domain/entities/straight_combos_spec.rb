...
RSpec.describe PokerArena::Domain::Entities::StraightCombo do
  describe '#score' do
    it 'return expected array for 5s 4c 3c 2c Ad' do
      cards = PokerArena::Domain::Entities::Card.array('5s 4c 3c 2c Ad')
    ...
    it 'return expected array for Ad Kh Qc Js Tc' do
      cards = PokerArena::Domain::Entities::Card.array('Ad Kh Qc Js Tc')
      combo = described_class.new(cards: cards)
