...
RSpec.describe PokerArena::Domain::Entities::Combo do
  it 'raise exception for too many cards' do
    cards = PokerArena::Domain::Entities::Card.array('7c Jc Tc 8c 9c 5s')
  ...
  describe '#royal_flush?' do
    it "return false when it's not a royal flush" do
      cards = PokerArena::Domain::Entities::Card.array('Jc Tc 8c 9c 7c ')
  ...
  describe '#straight_flush?' do
    it "return false when it's not a straight flush" do
      cards = PokerArena::Domain::Entities::Card.array('Jc Th 8c 9c 7c')
      combo = described_class.for(cards: cards)
    ...
    it "return true when it's a straight flush" do
      cards = PokerArena::Domain::Entities::Card.array('Jc Tc 9c 8c 7c')
      combo = described_class.for(cards: cards)
  ...
  describe '#four_of_a_kind?' do
    it "return false when it's not a four of a kind combo" do
      cards = PokerArena::Domain::Entities::Card.array('Jc Ts 8c 9c 7h')
      combo = described_class.for(cards: cards)
    ...
    it "return true when it's a four of a kind combo" do
      cards = PokerArena::Domain::Entities::Card.array('8h 8d 8s 8c 9c')
      combo = described_class.for(cards: cards)
  ...
  describe '#full_house?' do
    it "return false when it's not a full house" do
      cards = PokerArena::Domain::Entities::Card.array('7h Qc As 8c 9c')
      combo = described_class.for(cards: cards)
    ...
    it "return true when it's a full house" do
      cards = PokerArena::Domain::Entities::Card.array('Td Ts Tc 8c 8s')
      combo = described_class.for(cards: cards)
  ...
  describe '#flush?' do
    ...
    it 'return false when they are less than five cards' do
      cards = PokerArena::Domain::Entities::Card.array('Qc Ac 8c 9c')
      combo = described_class.for(cards: cards)
    ...
    it "return true when it's a flush" do
      cards = PokerArena::Domain::Entities::Card.array('7c Qc Tc 8c 9c')
      combo = described_class.for(cards: cards)
  ...
  describe '#straight?' do
    it "return false when it's not a straight" do
      cards = PokerArena::Domain::Entities::Card.array('Qc As 8c 9c 7h')
      combo = described_class.for(cards: cards)
    ...
    it "return true when it's a straight" do
      cards = PokerArena::Domain::Entities::Card.array('Jc Ts 9c 8c 7h')
      combo = described_class.for(cards: cards)
  ...
  describe '#three_of_a_kind?' do
    it "return false when it's not a three of a kind combo" do
      cards = PokerArena::Domain::Entities::Card.array('7h Jc Ts 8c 9c')
      combo = described_class.for(cards: cards)
    ...
    it "return true when it's a three of a kind combo" do
      cards = PokerArena::Domain::Entities::Card.array('8h Qc 8s 8c 9c')
      combo = described_class.for(cards: cards)
  ...
  describe '#two_pairs?' do
    ...
    it "return true when it's a two pairs combo" do
      cards = PokerArena::Domain::Entities::Card.array('9h Qc 8s 8c 9c')
      combo = described_class.for(cards: cards)
  ...
  describe '#pair?' do
    ...
    it "return true when it's a pair combo" do
      cards = PokerArena::Domain::Entities::Card.array('6h Qc 8s 8c 9c')
      combo = described_class.for(cards: cards)
  ...
  describe '#high_card?' do
    it "return true when it's only a high card combo" do
      cards = PokerArena::Domain::Entities::Card.array('6h Qc 3s 8c 9c')
      combo = described_class.for(cards: cards)
